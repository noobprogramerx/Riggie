namespace RiggieApp {
   ...
   */
  export class SealionViewer {
    private container: HTMLElement | null = null;
    private state: SealionState = 'idle';

    /**
     * コンストラクタ
     * @param props プロパティ
     */
    constructor(props: SealionViewerProps) {
     ...
     */
    public updateState(newState: SealionState): void {
  ...
  export class ControlPanel {
    private container: HTMLElement | null = null;
    private props: ControlPanelProps;
    ...
    private bindEvents(): void {
      ...
      btnShush.addEventListener('click', (e: Event) => {
        e.preventDefault();
      ...
      btnContinuous.addEventListener('click', (e: Event) => {
        e.preventDefault();
        this.isContinuousActive = !this.isContinuousActive;
        this.setContinuousState(this.isContinuousActive);
        this.props.onContinuousToggle(this.isContinuousActive);
      });
    }
  }
}
